...
import { materialLimitBindingsRouter } from "./routes/materialLimitBindings.js";
...
import { dailyAttendanceRouter } from "./routes/dailyAttendance.js";
...
app.use("/api/material-limit-bindings", materialLimitBindingsRouter);
...
app.use("/api/daily-attendance", dailyAttendanceRouter);
